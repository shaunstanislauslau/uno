...
namespace Windows.UI.Xaml.Automation.Peers
{
	...
	{
		// Skipping already declared method Windows.UI.Xaml.Automation.Peers.TimePickerAutomationPeer.TimePickerAutomationPeer(Windows.UI.Xaml.Controls.TimePicker)
